...
LABEL org.opencontainers.image.source="https://github.com/wize-works/wize-project"
LABEL org.opencontainers.image.documentation="https://github.com/wize-works/wize-project"
