...
[![status](https://img.shields.io/badge/status-active-brightgreen)](https://github.com/wizeworks/wize-wize-project)  
...
**wize-project** is a lightweight, multi-tenant **GraphQL API** for managing wize-projects, designed for flexible client applications.  
